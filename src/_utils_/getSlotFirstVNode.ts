...
function getSlotFirstVNode<T = { [key: string]: any }>(slot: Slot | undefined, identificationKey: Symbol | Symbol[] | null, flattenedData: true): TupleData<T & { [key: string]: any }>;

function getSlotFirstVNode<T = { [key: string]: any }>(slot: Slot | undefined, identificationKey?: Symbol | Symbol[] | null, flattenedData?: false): SpecificVNode<T & { [key: string]: any }> | null;

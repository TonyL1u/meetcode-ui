...
import type { Slots, RenderFunction, VNodeChild } from 'vue';

export function propsMergeSlots<T extends Record<string, any>, K extends keyof T>(props: T, slots: Slots, name: K, stringRenderer?: (prop: string) => VNodeChild, vnodeRenderer?: (vnode: VNodeChild) => VNodeChild) {

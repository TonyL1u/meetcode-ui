...
// 组件列表
const components = [McGrid, McGridItem, McPopconfirm, McPopover, McPopselect, McTextLink];
// 使用所有组件
const McUI = (app: App) => {
...
export { McGrid, McGridItem, McPopconfirm, McPopover, McPopselect, McTextLink, McUI };
export default { McUI };

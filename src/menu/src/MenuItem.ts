...
export default defineComponent({
    ...
    setup(props, { slots }) {
        ...
        const { padding: subMenuPadding, hidePopover: hideSubMenuPopover } = inject(subMenuInjectionKey, null) ?? {};
        const { padding: menuItemGroupPadding, hidePopover: hideMenuItemGroupPopover } = inject(menuGroupInjectionKey, null) ?? {};

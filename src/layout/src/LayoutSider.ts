...
export default defineComponent({
    ...
    setup(props, { slots }) {
        ...
        const { width, bordered } = toRefs(props);
        ...
        // main logic...
        return () => {
            return createVNode('aside', { class: ['mc-layout-sider', bordered.value ? 'mc-layout-sider--bordered' : ''], style: cssVars.value }, [renderSlot(slots, 'default')]);
        };
    }
});

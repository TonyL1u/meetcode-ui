...
function finishComponentSetup(instance, isSSR, skipOptions) {
    ...
    if (!Component.render && instance.render === NOOP && !isSSR) {
        ...
        if (!compile && Component.template) {
            warn$1(`Component provided template option but ` + `runtime compilation is not supported in this build of Vue.` + ` Use "vue.esm-browser.js" instead.` /* should not happen */);
        } else {
...
const compile$1 = () => {
    {
        warn$1(`Runtime compilation is not supported in this build of Vue.` + ` Use "vue.esm-browser.js" instead.` /* should not happen */);
    }
};
